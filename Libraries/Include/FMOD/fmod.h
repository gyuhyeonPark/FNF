...
FMOD_RESULT F_API FMOD_Sound_Lock                       (FMOD_SOUND *sound, unsigned int uvOffset, unsigned int length, void **ptr1, void **ptr2, unsigned int *len1, unsigned int *len2);
...
FMOD_RESULT F_API FMOD_Sound_GetSyncPointInfo           (FMOD_SOUND *sound, FMOD_SYNCPOINT *point, char *name, int namelen, unsigned int *uvOffset, FMOD_TIMEUNIT offsettype);
FMOD_RESULT F_API FMOD_Sound_AddSyncPoint               (FMOD_SOUND *sound, unsigned int uvOffset, FMOD_TIMEUNIT offsettype, const char *name, FMOD_SYNCPOINT **point);
