...
/// </summary>
TreeNode::TreeNode()
	: Parent(nullptr), m_Owner(nullptr), Framed(false)
{
...
void TreeNode::Tick()
{
	...
	// 노드가 자식 노드를 보유하고 있지 않으면 leaf 플래그 추가
...
void TreeNode::DragCheck()
{
	...
	{
		// Drag 사이에 Text를 넣어주면, 드래그 중인 마우스 위치에 Text가 따라다니며 렌더링.
...
TreeUI::TreeUI()
	: EditorUI("TreeUI"), m_Inst(nullptr), m_MemFunc(nullptr)
	, m_DDInst(nullptr), m_DDMemFunc(nullptr)
{
}
