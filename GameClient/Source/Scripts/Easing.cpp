...
double easeInSine(double t) {
    return 1 - cos((t * DirectX::XM_PI) / 2);
}

double easeOutSine(double t) {
    return sin((t * DirectX::XM_PI) / 2);;
}

double easeInOutSine(double t) {
    return -1 * (cos(DirectX::XM_PI * t) - 1) / 2;
}
...
double easeInElastic(double t) {
    const double c4 = (2 * DirectX::XM_PI) / 3;
...
double easeInOutElastic(double t) {
    const double c5 = (2 * DirectX::XM_PI) / 4.5;
