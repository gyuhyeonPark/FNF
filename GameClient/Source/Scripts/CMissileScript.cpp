...
CMissileScript::CMissileScript()
	: CScript(SCRIPT_TYPE::MISSILESCRIPT), m_speed(300.f), m_targetObj(nullptr)
{
}
...
void CMissileScript::SaveToSceneFile(FILE* _File)
{
}

void CMissileScript::LoadFromSceneFile(FILE* _File)
{
}
